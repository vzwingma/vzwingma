...
Vérifie si `.claude/instructions/architect.instructions.md` existe dans projet courant. Si oui :
- Lis intégralement
...
- **Procédure exécution phase :** Suivre skill `.claude/skills/plan-phase-execution/SKILL.md`
- **Rédaction ADR :** Suivre skill `.claude/skills/adr-writing/SKILL.md` après chaque décision architecturale validée
