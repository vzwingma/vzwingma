...
**Dépôt transverse multi-agents Copilot** — Infrastructure réutilisable pour orchestrer développement via GitHub Copilot.

Stack principale : Markdown, YAML frontmatter
Type : Templates, agents, prompts (pas de code applicatif)
...
- **Trigger :** "Conçois une architecture pour", "Crée un plan pour"
...
- **Trigger :** "Implémente cette fonctionnalité", "Développe selon l'architecture"
...
- **Trigger :** "Écris des tests pour", "Génère des tests unitaires"
...
- **Trigger :** "Mets à jour la documentation", "Garde les docs en sync"
...
**Pas de commandes build/test** : dépôt documentation-only.
...
- Pas de dépendances données entre tâches
