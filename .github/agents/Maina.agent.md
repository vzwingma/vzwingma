...
**Au démarrage chaque session**, vérifie si `.github/instructions/orchestrator.instructions.md` existe dans projet courant. Si oui :
- Lis intégralement
...
- Skill plan-creation: `.github/skills/plan-creation/SKILL.md`
- Skill plan-phase-execution: `.github/skills/plan-phase-execution/SKILL.md`
- Index plans: `.github/plans/README.md`
