...
> **Versioning** : Description démarre par numéro version (ex. `[v1.9]`). Incrémenter à chaque modif.
...
> **Changements v2.9 → v3.0** : Migration vers Claude Opus 4.7 pour capacités planification/architecture améliorées.
