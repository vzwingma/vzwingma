...
> Workflow global + relations inter-agents (source unique) : [`.github/README.md`](../README.md)

## 📂 Spécificités projet

**Au démarrage chaque session**, lectures dans l'ordre :

1. **`.github/instructions/architect.instructions.md`** (si présent) — conventions, protocoles, contraintes.
...
- **Procédure exécution phase :** skill `.github/skills/plan-phase-execution/SKILL.md`
- **Rédaction ADR :** skill `.github/skills/adr-writing/SKILL.md` après chaque décision validée
