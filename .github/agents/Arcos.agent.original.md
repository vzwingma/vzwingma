...
> **Changements v2.8 → v2.9** : Ajout de la règle absolue de respect du `.copilotignore`.
> **Changements v2.9 → v3.0** : Migration vers Claude Opus 4.7 pour capacités de planification et d'architecture améliorées.
