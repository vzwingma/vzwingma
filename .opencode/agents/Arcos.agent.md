...
> Workflow global + relations inter-agents (source unique) : [`.opencode/README.md`](../README.md)

## 📂 Spécificités projet

**Au démarrage chaque session**, lectures dans l'ordre :

1. **`.opencode/instructions/architect.instructions.md`** (si présent) — conventions, protocoles, contraintes.
...
> 🔒 Sécurité : opérations destructives et respect de `.gitignore` couverts par les skills
...
- **Procédure exécution phase :** skill `.opencode/skills/plan-phase-execution/SKILL.md`
- **Rédaction ADR :** skill `.opencode/skills/adr-writing/SKILL.md` après chaque décision validée
